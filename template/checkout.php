   ...
   if($cart_query && $detail_query){
      ...
      <div class='message-container'>
         ...
         <div class='customer-details'>
            ...
            <a href='indexfront.php' class='btn'>continue shopping</a>
         </div>
      </div>
      ";
   }
...
<section class="checkout-form">
   ...
   <div class="display-order">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>Street</span>
            <input type="text" placeholder="e.g. street Hamra" name="street" required>
         </div>
         <div class="inputBox">
            <span>city</span>
            <input type="text" placeholder="e.g. Beirut" name="city" required>
         </div>
        
         <div class="inputBox">
            <span>country</span>
            <input type="text" placeholder="e.g. Lebanon" name="country" required>
         </div>
