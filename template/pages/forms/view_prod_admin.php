...
<body>
  ...
  <div class="container-scroller">
    ...
    <?php
        ...
        if($super_admin==2){
          ...
          while($row = mysqli_fetch_array($result)){
             ...
             $qry2 = "SELECT id FROM user Where id = $row[user_id]";
   ...
   <?php 
    if($super_admin==2){
      echo"
      <a href='view_users.php' style='width:10rem;margin-left:42.1%;margin-top:0.2rem' class='btn btn-primary'>View all users</a>
